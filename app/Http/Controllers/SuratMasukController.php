...
class SuratMasukController extends Controller
{
    ...
    {
        // Proteksi murni data contoh default master system (ID 1 / Tahun 2000 / Nomor Urut 0)
        if (($suratMasuk->tahun == 2000 && $suratMasuk->nomor_urut == 0) || $suratMasuk->nomor_surat === '000/SMP/SAMPLE/2000') {
            return redirect()
