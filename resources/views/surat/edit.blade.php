            ...
            <form action="{{ route('surat.update', $surat->id) }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" name="tgl_surat" class="form-control" value="{{ old('tgl_surat', $surat->tgl_surat ? $surat->tgl_surat->format('Y-m-d') : date('Y-m-d')) }}" required>
                    </div>
                ...
                @if($surat->jenis_surat === 'aktif_belajar')
                    ...
                    <!-- HIDDEN FIELDS: Data Terisi Otomatis Berdasarkan Siswa yang Dipilih -->
                ...
                @if($surat->jenis_surat === 'aktif_mengajar')
                    ...
                    <!-- HIDDEN FIELDS: Data Terisi Otomatis Berdasarkan Guru yang Dipilih -->
                ...
                @if($surat->jenis_surat === 'custom')
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="tujuan_penerima" class="form-control" value="{{ old('tujuan_penerima', $surat->tujuan_penerima) }}" required>
                        </div>
                        <div class="col-md-6">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (btnAdd && container) {
            btnAdd.addEventListener('click', function() {
                ...
                // Reset nilai select pada baris baru yang di-clone
