    ...
    <div id="document-render" style="padding: 10px; background: #fff;">
                ...
                <td style="width: 55%;">
                    <table style="border-collapse: collapse;">
                        ...
                        <tr>
                            <td>Perihal</td>
                            <td>:</td>
                            <td class="font-bold">{{ strtoupper($surat->perihal ?? $p['perihal'] ?? 'PERMOHONAN') }}</td>
                        </tr>
                        <tr>
                            <td>Lamp</td>
                            <td>:</td>
        ...
        <div class="content-indented-wrapper">
            ...
            @else
                ...
                <p class="paragraf-isi">
                    Disampaikan dengan hormat, sehubungan dengan pelaksanaan kegiatan sekolah di SMP Muhammadiyah Tonjong, dengan ini kami mengajukan permohonan berkenaan dengan:
                </p>
            @endif

            <!-- DETAIL ACARA / PERMOHONAN -->
            ...
            @else
                <p class="paragraf-isi">
                    Demikian surat permohonan ini kami sampaikan. Atas perhatian, perkenan, dan bantuan Bapak/Ibu, kami ucapkan terima kasih.
                </p>
            @endif
        ...
        <script>
            window.addEventListener('DOMContentLoaded', () => {
                ...
                const opt = {
                    ...
                    filename:     'PMH_{{ str_replace(["/", "\\"], "-", $surat->nomor_surat) }}.pdf',
