...
<head>
    ...
    <style>
        ...
        /* WRAPPER INDENTASI ISI UTAMA */
        .content-indented-wrapper {
            margin-left: 77px;
        }

        /* TUJUAN PENERIMA SURAT (SPASI 1.15) */
        .penerima-block {
            margin-top: 8px;
            margin-bottom: 12px;
            line-height: 1.2;
        ...
        p.paragraf-isi {
            line-height: 1.5; /* FORMAT SPASI 1.5 SESUAI ATURAN RESMI */
            margin: 0 0 10px 0;
            text-align: justify;
            text-indent: 0px;
        }
        ...
        /* RINCIAN ACARA TABLE (SPASI 1.15 - TIGHT) */
        .table-data {
    ...
    <div id="document-render" style="padding: 10px; background: #fff;">
                ...
                <td style="width: 55%;">
                    <table style="border-collapse: collapse;">
                        ...
                        <tr>
                            <td>Perihal</td>
                            <td>:</td>
                            <td class="font-bold">{{ strtoupper($surat->perihal) }}</td>
                        </tr>
                        <tr>
                            <td>Lamp</td>
                            <td>:</td>
        ...
        <div class="content-indented-wrapper">
            ...
            <div class="penerima-block">
                <div>Kepada Yth.</div>
                <div class="font-bold">{{ strtoupper($p['penerima'] ?? $surat->tujuan_penerima ?? $surat->tujuan) }}</div>
            ...
            @else
                <p class="paragraf-isi">
                    Puji Syukur kita sampaikan atas kehadirat Allah SWT, atas Rahmat dan Karunia-Nya, sehingga kita selalu diberikan nikmat Sehat wal Afiat.
                </p>
                <p class="paragraf-isi">
                    Disampaikan dengan hormat, berkenaan dengan telah dimulainya Kegiatan Belajar Mengajar SMP Muhammadiyah Tonjong, maka dengan ini kami mengharap kehadiran Bapak pada:
                </p>
            @endif
            ...
            @else
                <p class="paragraf-isi">
                    Mengingat pentingnya acara, maka dimohon untuk <strong>HADIR TEPAT WAKTU</strong>, supaya kegiatan dapat berjalan dengan lancar dan maksimal.
                </p>
                <p class="paragraf-isi">
                    Demikian Undangan ini kami sampaikan, atas perhatian, kerjasama, dan kehadirannya kami sampaikan terima kasih.
                </p>
            @endif
        ...
        <div class="ttd-container">
            <div class="ttd-block">
                ...
                <div class="font-bold" style="text-decoration: underline;">
                    {{ $p['penandatangan_nama'] ?? $pengaturan->nama_kepala_sekolah ?? 'IRFAN TUNZILA, S. Ag.' }}
                </div>
        ...
        <script>
            window.addEventListener('DOMContentLoaded', () => {
                ...
                const opt = {
                    ...
                    filename:     'UND_{{ str_replace(["/", "\\"], "-", $surat->nomor_surat) }}.pdf',
