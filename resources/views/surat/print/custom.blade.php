...
<head>
    ...
    <title>Surat Custom - {{ $surat->nomor_surat }}</title>
    ...
    <style>
        ...
        /* RINCIAN ACARA TABLE (SPASI 1.15) */
        .table-data {
...
<body>
    ...
    <div id="document-render" style="padding: 10px; background: #fff;">
                ...
                <td style="width: 55%;">
                    <table style="border-collapse: collapse;">
                        ...
                        <tr>
                            <td>Perihal</td>
                            <td>:</td>
                            <td class="font-bold">{{ strtoupper($surat->perihal ?? $p['perihal'] ?? 'SURAT KHUSUS') }}</td>
                        </tr>
                        <tr>
                            <td>Lamp</td>
                            <td>:</td>
        ...
        <div class="content-indented-wrapper">
            ...
            <!-- PARAGRAF PEMBUKA / ISI UTAMA SURAT (SPASI 1.5) -->
            @if(!empty(trim($p['isi_surat'] ?? $p['paragraf_pembuka'] ?? '')))
                <p class="paragraf-isi">
                    {!! nl2br(e($p['isi_surat'] ?? $p['paragraf_pembuka'])) !!}
                </p>
            @else
                <p class="paragraf-isi">
                ...
                <p class="paragraf-isi">
                    Sehubungan dengan hal tersebut, bersama surat ini kami sampaikan informasi resmi dari SMP Muhammadiyah Tonjong.
                </p>
            @endif

            <!-- DETAIL ACARA / KETERANGAN KONDISIONAL -->
            @if(!empty($p['hari_tanggal']) || !empty($p['waktu_acara']) || !empty($p['waktu']) || !empty($p['tempat_acara']) || !empty($p['agenda_acara']) || !empty($p['agenda']))
        ...
        <script>
            window.addEventListener('DOMContentLoaded', () => {
                ...
                const opt = {
                    ...
                    filename:     'CUSTOM_{{ str_replace(["/", "\\"], "-", $surat->nomor_surat) }}.pdf',
