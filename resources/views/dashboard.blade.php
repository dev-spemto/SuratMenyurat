...
<div class="container-fluid">
    ...
    <!-- STATISTIK PEMBUATAN DOKUMEN (READ ONLY) -->
    <div class="card border-0 shadow-sm rounded-3 mb-4">
        ...
        <div class="card-body p-3">
            <div class="row g-3">
                    ...
                    <div class="card border rounded-3 h-100 bg-light-subtle">
                        <div class="card-body p-3 d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h4 class="fw-bold text-info m-0">{{ $totalSppd ?? 0 }}</h4>
                            </div>
                ...
                <!-- 2. KET. AKTIF MENGAJAR -->
                <div class="col-12 col-sm-6 col-md-4 col-xl-3">
                    <div class="card border rounded-3 h-100 bg-light-subtle">
                        <div class="card-body p-3 d-flex align-items-center justify-content-between">
                            <div>
                                <span class="text-muted small fw-bold d-block mb-1">Ket. Aktif Mengajar</span>
                                <h4 class="fw-bold text-warning m-0">{{ $totalAktifMengajar ?? 0 }}</h4>
                            </div>
                    ...
                    <div class="card border rounded-3 h-100 bg-light-subtle">
                        <div class="card-body p-3 d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h4 class="fw-bold text-success m-0">{{ $totalAktifBelajar ?? 0 }}</h4>
                            </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-xl-3">
                    <div class="card border rounded-3 h-100 bg-light-subtle">
                        <div class="card-body p-3 d-flex align-items-center justify-content-between">
                            <div>
                                <span class="text-muted small fw-bold d-block mb-1">Surat Undangan</span>
                                <h4 class="fw-bold text-primary m-0">{{ $totalUndangan ?? 0 }}</h4>
                            </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-xl-3">
                    <div class="card border rounded-3 h-100 bg-light-subtle">
                        <div class="card-body p-3 d-flex align-items-center justify-content-between">
                            <div>
                                <span class="text-muted small fw-bold d-block mb-1">Surat Pemberitahuan</span>
                                <h4 class="fw-bold text-danger m-0">{{ $totalPemberitahuan ?? 0 }}</h4>
                            </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-xl-3">
                    <div class="card border rounded-3 h-100 bg-light-subtle">
                        <div class="card-body p-3 d-flex align-items-center justify-content-between">
                            <div>
                                <span class="text-muted small fw-bold d-block mb-1">Surat Permohonan</span>
                                <h4 class="fw-bold text-success m-0">{{ $totalPermohonan ?? 0 }}</h4>
                            </div>
                            <div class="bg-success text-white rounded-circle p-3 d-flex align-items-center justify-content-center" style="width: 48px; height: 48px;">
                    ...
                    <div class="card border rounded-3 h-100 bg-light-subtle">
                        <div class="card-body p-3 d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <h4 class="fw-bold text-secondary m-0">{{ $totalCustom ?? 0 }}</h4>
                            </div>
                            <div class="bg-secondary text-white rounded-circle p-3 d-flex align-items-center justify-content-center" style="width: 48px; height: 48px;">
